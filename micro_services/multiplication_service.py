...
class MultiplicationService(MultiplicationServiceServicer):
    def MultiplyNumbers(self, request, context):
        """
        Multiply two numbers provided in the request and returns the result in JSON format.
        ...
        try:
            ...
            # Compute the multiplication using the helper function.
            result = multiply(a, b)
...
def process_tasks(redis_handler):
    """
    Processes pending tasks from Redis using the multiplication logic.
        ...
        if task_json:
            try:
                ...
                if datetime.utcnow() > expiration_dt:
                    ...
                    # Compute the result using the multiply function.
                    result = multiply(a, b)
...
def serve():
    """
    Starts the MultiplicationService gRPC server and the Redis tasks consumer.
    """
